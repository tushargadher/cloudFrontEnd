    ...
    return (
        <>
            <ToastContainer
                ...
                autoClose={3000}
            />
            <div className={`h-3/4 md:h-2/3  md:p-5 flex flex-col justify-between ${display === 'false' ? " " : "blur-[3px]"}`}>
                        ...
                        <div className="modal-content border-none shadow-lg relative flex flex-col w-full pointer-events-auto bg-white bg-clip-padding rounded-md outline-none text-current">
                            ...
                            <div className="modal-body relative p-4">
                                <div className="mb-6">
                                    ...
                                    <input type="text" value={note.title} id="title" name="title" className="block p-2.5 w-full text-sm text-gray-900 rounded-md shadow-md bg-gray-100 dark:border-gray-600 outline-gray-600" placeholder="Add Note title..." onChange={hanldeOnchange} maxLength="15" />
                                </div>
                                <div>
                                ...
                                <div >
                                    ...
                                    <input type="text" value={note.tag} id="tag" name="tag" className="block p-2.5 w-full text-sm text-gray-900 rounded-md  shadow-md bg-gray-100 dark:border-gray-600 outline-gray-600" placeholder="Add Note tag..." onChange={hanldeOnchange} maxLength="12" />
                                </div>
                            </div>
